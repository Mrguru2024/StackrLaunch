        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="mt-24 text-center">
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-200">
              Join us today and experience the power of our platform.
            </p>
            <div className="mt-8 flex justify-center gap-4">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center px-6 py-3 border border-indigo-200 text-base font-medium rounded-md text-indigo-700 bg-white hover:bg-indigo-50 dark:bg-[#232b3b] dark:text-indigo-200 dark:border-[#232b3b] dark:hover:bg-[#232b3b]/80"
              >
                Contact Us
              </Link>
            </div>
