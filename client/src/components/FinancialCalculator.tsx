      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Use our calculator to see how Stackr can help automate your finances and build wealth over time.
          </p>
        </motion.div>
              ...
              <Card className="shadow-lg h-full">
                ...
                <CardContent className="pt-6">
                  <div className="space-y-8">
                    <div>
                      <h5 className="text-sm font-medium text-gray-500 mb-1">Yearly Automated Savings</h5>
                      <p className="text-2xl font-bold">{formatCurrency(yearlyAutomatedSavings)}</p>
                    </div>
                    
                    <div className="pt-4 border-t">
                      <h5 className="text-sm font-medium text-gray-500 mb-1">After {years} Years Without Stackr</h5>
                      <p className="text-2xl font-bold">{formatCurrency(projectedSavings)}</p>
                      <p className="text-sm text-gray-500">Simple savings without investment growth</p>
                    </div>
                    
                    <div className="p-4 bg-green-50 rounded-lg border border-green-100">
                      <h5 className="text-sm font-medium text-gray-700 mb-1">After {years} Years With Stackr</h5>
                      <p className="text-3xl font-bold text-primary">{formatCurrency(stackrSavings)}</p>
                      <p className="text-sm text-gray-600">Automated savings with smart investments</p>
