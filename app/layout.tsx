...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'AI-powered financial automation that saves you $650/year & 5+ hours monthly. Built for variable incomes, freelancers, and contractors. Join 131+ early adopters!',
    images: [
      {
  ...
  twitter: {
    ...
    description: 'Smart money management that actually works for tradespeople, side hustlers, and people with variable income. Save time & money automatically.',
