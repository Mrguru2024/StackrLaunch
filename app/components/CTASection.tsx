...
export default function CTASection({ waitlistUrl }: CTASectionProps) {
  ...
  return (
    <section
      id="join-waitlist"
      className="py-20 md:py-32 px-4 bg-gradient-to-br from-primary via-purple-700 to-indigo-800 text-white"
    >
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-xl md:text-2xl mb-12 text-purple-100">
            Join the Stackr waitlist today and be among the first to take control of your finances
        ...
        >
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              <Label htmlFor="email" className="text-sm font-medium text-gray-700 text-left mb-1">
                Email Address
              </Label>
              <Input
                type="email"
            ...
            <p className="text-xs text-gray-500 mt-4">
              By joining, you agree to receive updates about Stackr. We respect your privacy and
