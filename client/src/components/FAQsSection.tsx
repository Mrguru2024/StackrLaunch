      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 mb-4">
            Join our waitlist to get updates and ask specific questions about how Stackr can help with your financial needs.
          </p>
          <button
