  ...
  return (
    <section id="testimonials" className="py-16 md:py-24 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Why Early Users Love Stackr</h2>
          <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
            Here's what our beta testers are saying about how Stackr has transformed their financial lives.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
            ...
            <blockquote className="text-gray-700 mb-6">
              "As an electrician with irregular income, Stackr has been a game-changer. I've saved over $4,200 in six months without even thinking about it."
            </blockquote>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
            ...
            <blockquote className="text-gray-700 mb-6">
              "Stackr found $175 in monthly subscriptions I'd forgotten about and helped me set up a tax savings plan that's already saved me thousands."
            </blockquote>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
            ...
            <blockquote className="text-gray-700 mb-6">
              "After 15 years in construction, I've never felt more confident about my finances. The automated saving rules are perfect for my irregular paychecks."
            </blockquote>
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="mt-3 text-gray-600">Early results from our beta program show real financial impact.</p>
          </div>
